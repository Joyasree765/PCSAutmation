...
public class ViewProfile extends JFrame {
	...
	{	 empController=new EmploeeController();
		conn=JDBCConnection.getDBConnection();
			...
			frame1 = new JFrame(".Profile Selected");
			...
			lblUserId.setFont(new Font(".Time New Roman", Font.BOLD, 15));
			lblUserId.setBounds(60, 40, 130, 30);
			frame1.getContentPane().add(lblUserId);
			
			
			JLabel lblEmployeeId = new JLabel(".Employee Id");
			lblEmployeeId.setFont(new Font(".Time New Roman", Font.BOLD, 15));
			...
			btnSubmit.addActionListener(new ActionListener ()
			{
				public void actionPerformed(ActionEvent arg0)
				{
					...
					//emp=empController.checkId(userId);
						int s1;
